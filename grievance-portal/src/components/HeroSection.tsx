...
const HeroSection = () => {
  const stats = [
    { value: "12K+", label: "Complaints", icon: FileText },
    { value: "89%", label: "Resolution", icon: CheckCircle2 },
    { value: "3.5d", label: "Avg Time", icon: Clock },
  ];
    ...
    <section className="relative min-h-screen hero-gradient overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 pt-32 pb-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Report civic issues, track progress in real-time, and help build a better community for everyone.
          </motion.p>
